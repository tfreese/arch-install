...
cryptsetup luksFormat --verbose --verify-passphrase --key-size 512 --hash sha512 --use-random --cipher aes-xts-plain64 /dev/md1;
cryptsetup luksOpen /dev/md1 crypt_lvm;
