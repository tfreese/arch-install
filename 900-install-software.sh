...
pacman --noconfirm --needed -S asciidoc asciidoctor; # Konverter für asciidoc
...
pacman --noconfirm --needed -S jdk25-openjdk openjdk25-src; # LTS
pacman --noconfirm --needed -S jdk21-openjdk openjdk21-src; # LTS
...
pacman --noconfirm --needed -S torbrowser-launcher;
# google-chrome (aur)
